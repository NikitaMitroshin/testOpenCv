...
public class Main {
    ...
    private static final String FILE_NAME = "resources/images/test/dasha.jpg";
    private static final String RESULT_FILE_NAME = "resources/images/result/dasha.jpg";
    ...
    public static void main(String[] args) {
        ...
        for (Rect aFacesArray : facesArray) {
            Imgproc.rectangle(radImage, aFacesArray.tl(), aFacesArray.br(), new Scalar(0, 255, 0), 3);
        }
//        Mat image_roi = new Mat(radImage,facesArray[0]);
//        Imgcodecs.imwrite(RESULT_FILE_NAME, image_roi);
